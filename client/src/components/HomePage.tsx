  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      content:
        "Welcome to Code Infinity! I'm your AI programming assistant. How can I help you today?",
      isUser: false,
      type: "message",
    },
  ]);
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (currentMessage.trim()) {
      ...
      try {
        ...
        let url = `https://chatbot-server-0mbz.onrender.com/chat_stream/${encodeURIComponent(
          userInput
        )}`;
        if (checkpointId) {
